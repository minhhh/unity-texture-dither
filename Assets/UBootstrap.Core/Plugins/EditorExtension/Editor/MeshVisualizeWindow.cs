...
/// <summary>
/// Taken from https://gist.github.com/TJHeuvel/c4f8d218a0d774682560a8f348a90dff
/// </summary>
namespace UBootstrap.Editor
{
    public class MeshVisualizeWindow : EditorWindow
    {
        [MenuItem ("UBootstrap/Mesh visualizer")]
        ...
        private void VisualizeVertices ()
        {
            for (int i = startVertIndex; i < endVertIndex; i++) {
                ...
                DrawRay (selectedVertices [i], selectedNormals [i] * 0.5f);
                Handles.Label (selectedVertices [i] + selectedNormals [i] * 0.5f, i.ToString ());
            }
        }
